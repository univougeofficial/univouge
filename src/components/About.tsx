  ...
  const items = [
    {
      ...
      desc: "Honoring South Indian craftsmanship through authentic silks, heritage motifs, and artisanal weaving.",
    },
    {
      icon: Palette,
      title: "Designing with Purpose",
      desc: "Every outfit is created with intention — blending personality, culture, and couture precision.",
    },
    {
      icon: Scissors,
      title: "Precision Craftsmanship",
      desc: "Handcrafted excellence where every detail, zari thread, and stitch is perfected with care.",
    },
    {
      icon: Heart,
      title: "Wedding Styling",
      desc: "Bespoke bridal and groom ensembles with jewelry coordination and family styling.",
    },
    {
      icon: Film,
      title: "Movie Costumes",
      desc: "Authentic and contemporary ethnic wear for cinema, created with period research and multiple fittings.",
    },
    {
      icon: Calendar,
      title: "Event Couture",
      desc: "Premium designer pieces curated for red carpets, celebrations, and high-profile occasions.",
    },
    {
      icon: Users,
      title: "Family Ensemble Styling",
      desc: "Coordinated themes and personalized attire for all age groups and family events.",
    },
  ];
        ...
        <div className="max-w-5xl mx-auto mb-24">
          ...
          <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
            <p>
              ...
              Rooted in South Indian heritage and refined through contemporary design,
        ...
        <div className="relative w-full overflow-visible px-0">
          <div className="w-full h-[420px] flex items-center justify-center relative px-20">
            {items.map((item, i) => {
              ...
              const x = delta * 340; // spacing between panels
